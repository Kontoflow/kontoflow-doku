...
<Aside>Neben der Anwendung startet auch ein CMD-Fenster, welches jedoch einfach ignoriert werden kann. Siehe auch [Bekannte Probleme](/bedienung/bekannteprobleme). </Aside>
...
<Aside type="caution">Die Debug-Dateien enthalten sensible personenbezogene Daten des jeweiligen Umzugskunden, die Weitergabe der Debug-Dateien ist daher nicht unbedenklich. Siehe auch [Debuggen](/bedienung/debug). </Aside>
...
<Aside>Derzeit friert die Anwendung ein, während die PDF Dateien verarbeitet werden. Dennoch wird im Hintergrund der Prozess fortgesetzt. Nach Abschluss der Verarbeitung ist die Anwendung wieder responsive. Siehe auch [Bekannte Probleme](/bedienung/bekannteprobleme). </Aside>
